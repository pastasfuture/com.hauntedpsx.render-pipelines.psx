...
{
    sealed class PSXLitSubTarget : SubTarget<PSXTarget>
    {
        static readonly GUID kSourceCodeGuid = new GUID("a3bc4d88919fc164c9763c1ee2fda8a8"); // PSXLitSubTarget.cs

        public PSXLitSubTarget()
        {
            displayName = "Unlit";
        }
        ...
        public override void GetFields(ref TargetFieldContext context)
        {
            ...
            context.AddField(PSXFields.SurfaceOpaque, target.surfaceType == SurfaceType.Opaque);
            context.AddField(PSXFields.SurfaceTransparent, target.surfaceType != SurfaceType.Opaque);
            context.AddField(PSXFields.BlendAdd, target.surfaceType != SurfaceType.Opaque && target.alphaMode == AlphaMode.Additive);
            context.AddField(Fields.BlendAlpha, target.surfaceType != SurfaceType.Opaque && target.alphaMode == AlphaMode.Alpha);
            context.AddField(PSXFields.BlendMultiply, target.surfaceType != SurfaceType.Opaque && target.alphaMode == AlphaMode.Multiply);
            context.AddField(PSXFields.BlendPremultiply, target.surfaceType != SurfaceType.Opaque && target.alphaMode == AlphaMode.Premultiply);
        }
        ...
        static class SubShaders
        {
            ...
            {
                pipelineTag = PSXTarget.kPipelineTag,
                customTags = PSXTarget.kLitMaterialTypeTag,
        ...
        {
            const string kPSXLitPass = "Packages/com.hauntedpsx.render-pipelines.psx/Editor/Material/ShaderGraph/Includes/PSXLitPass.hlsl";
            ...
            public static IncludeCollection Unlit = new IncludeCollection
            {
                ...
                { kPSXLitPass, IncludeLocation.Postgraph },
            };
        }
        #endregion
    }
